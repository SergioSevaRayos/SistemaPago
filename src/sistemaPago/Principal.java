...
public class Principal {
	...
	private static void menu() {
		...
		private static void tarjeta() {
			...
			System.out.println("Formatos de numeración de las tarjetas\n"
			...
			if (americanOk == 0) {
				...
				System.out.println("Número 	--> " + entradaTarj);
		...
		private static void resumen() {
			...
			System.out.println("Tipo --> " + vis);
			System.out.println("Cantidad a abonar: " + inputPagar + " €");
			System.out.println("Número de tarjeta: " + entradaTarj + "");
			System.out.println("Estado --> PAGO REALIZADO");
			System.out.println("-------------------------------------------------");
		}
}
